...
```shell
go get github.com/godotenv/godotenv
```
...
go >= 1.17
```shell
go install github.com/godotenv/godotenv/cmd/godotenv@latest
```

go < 1.17
```shell
go get github.com/godotenv/godotenv/cmd/godotenv
```
...
```go
import _ "github.com/godotenv/godotenv/autoload"
```
